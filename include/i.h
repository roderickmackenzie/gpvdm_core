...
void inter_div_long_double(struct istruct* in,gdouble div);
...
void inter_sub_long_double(struct istruct* in,gdouble value);
...
void inter_add_long_double(struct istruct* in,gdouble value);
